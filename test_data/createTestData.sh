...
singularity exec 'docker://gudmaprbk/seqtk1.3:1.0.0' seqtk sample -s100 ./NEW_test_data/fastq/Q-Y5F6.R1.fastq.gz 1000 1> Q-Y5F6_25K.R1.fastq
singularity exec 'docker://gudmaprbk/seqtk1.3:1.0.0' seqtk sample -s100 ./NEW_test_data/fastq/Q-Y5F6.R2.fastq.gz 1000 1> Q-Y5F6_25K.R2.fastq
pigz Q-Y5F6_25K.R1.fastq
pigz Q-Y5F6_25K.R2.fastq
cp Q-Y5F6_25K.R1.fastq.gz ./NEW_test_data/fastq/xsmall/Q-Y5F6_25K.R1.fastq.gz
cp Q-Y5F6_25K.R2.fastq.gz ./NEW_test_data/fastq/xsmall/Q-Y5F6_25K.R2.fastq.gz
