...
ln -s /project/BICF/BICF_Core/shared/gudmap/references/new/GRCm38.p6.vM25/metadata/geneID.tsv
ln -s /project/BICF/BICF_Core/shared/gudmap/references/new/GRCm38.p6.vM25/metadata/Entrez.tsv
