...
curl --request GET https://img.shields.io/badge/Development%20Successful%20Replicates-${staging_success}/${staging_total}-green?style=flat > ./badges/counts/staging_success.svg
curl --request GET https://img.shields.io/badge/Development%20Erroneous%20Replicates-${staging_error}/${staging_total}-red?style=flat > ./badges/counts/staging_error.svg
curl --request GET https://img.shields.io/badge/Development%20Successful%20Replicates-${prod_success}/${prod_total}-green?style=flat > ./badges/counts/prod_success.svg
curl --request GET https://img.shields.io/badge/Development%20Erroneous%20Replicates-${prod_error}/${prod_total}-red?style=flat > ./badges/counts/prod_error.svg
